    ...
    return (
        ...
        >
            <div className="relative overflow-hidden rounded-lg">
                ...
                />
                <div className="absolute inset-0 rounded-lg bg-black/0 group-hover:bg-black/40 transition-colors duration-300" />

                {(media.ifFavorite || media.ifFinished) && (
                    <div className="absolute bottom-1.5 right-1.5 flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                        {media.ifFinished && (
            ...
            <div className="flex items-start justify-between gap-2">
                <p className="text-xs text-white font-medium leading-tight line-clamp-2 flex-1 min-w-0">{media.title}</p>
