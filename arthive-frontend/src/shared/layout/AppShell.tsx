...
export default function AppShell({user, setUser}: {user: User | null, setUser: (user: User | null) => void}) {
                    ...
                    <nav className="bg-[#171519] rounded-2xl border border-white/5 py-2">
                        ...
                        {user && (
                            <button
                                ...
                                className={`w-full text-left px-6 py-3 text-sm transition border-l-2 flex items-center gap-2 ${
