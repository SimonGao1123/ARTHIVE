...
import { obtainNotificationsData } from "@/data/notifications/obtainNotificationsData"
import { readNotificationsData } from "@/data/notifications/readNotifications"
import { OBTAIN_NOTIFICATIONS_QUERY } from "@/apollo/queries/shared_queries"
import type { Notification as NotificationData, ObtainNotificationsResponse, ObtainNotificationFilterEnum } from "@/types/queries/shared_queries_types"
import type { ReadNotificationsInput as ObtainNotificationsInput } from "@/types/mutations/shared_mutations_types"
import { READ_NOTIFICATIONS_MUTATION } from "@/apollo/mutations/shared_mutations"
import type { ReadNotificationsInput, ReadNotificationsResponse } from "@/types/mutations/shared_mutations_types"
import { MANIPULATE_FOLLOW_MUTATION, SEND_FOLLOW_MUTATION } from "@/apollo/mutations/follow_mutations"
import type { ManipulateFollowInput, ManipulateFollowResponse, SendFollowInput, SendFollowResponse } from "@/types/mutations/follow_mutations_types"
import { manipulateFollowRequest } from "@/data/user/manipulateFollowRequest"
